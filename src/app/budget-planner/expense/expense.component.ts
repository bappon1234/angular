...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule,CommonModule,MatIconButton],
...
export class ExpenseComponent {
  ...
  expenses: { month: string, expensesAmount: number }[] = [
    { month: 'January', expensesAmount: 1500 },
    { month: 'February', expensesAmount: 2000 },
    { month: 'March', expensesAmount: 1800 }
  ];
  monthSelected: boolean = false;
  januaryExpense: any[] = [
    { expenseType: 'Rent', expenseAmount: 1000 },
    { expensetype: 'Groceries', expeseAmount: 500 },
  ];
  februaryExpense: any[] = [
